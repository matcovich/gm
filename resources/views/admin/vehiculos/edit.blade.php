    ...
    <main id="main-container">
        ...
        <div class="content">
            <nav class="breadcrumb bg-white push">
                ...
                <span class="breadcrumb-item active">Crear nuevo vehiculo</span>
                ...
                <div class="col-md-6">
                    <div class="block block-sombraGM">
                        <div class="block-header bg-pulse-light">
                            <h3 class="block-title text-white">Crear un nuevo Vehiculo</h3>
                                ...
                                <div class="block-content">
                                    <form method="POST" action="#" >
                                        ...
                                        <div class="row justify-content-center mt-20">
                                            <div class="col-xl-10">
                                                <div class="form-group  {{ $errors->has('user_id') ? 'is-invalid' : '' }} row">
                                                    <label class="col-4" for="example-select2">Cliente</label>
                                                    <div class="col-lg-8">
                                                        <select class="js-select2 form-control" id="users" name="user_id" style="width: 100%;" data-placeholder="Seleccione dueño del vehiculo">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-10">
                                                ...
                                                <div class="form-group {{ $errors->has('combustible') ? 'is-invalid' : '' }}  row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <label class="css-control-lg css-control-success css-radio">
                                                            <input type="radio"
                                                                   {{ old('combustible') == "2" ? 'checked' : '' }}
                                                                   class="css-control-input  ml-50 mr-20"
                                                                   name="combustible" value="2">
                                        ...
                                        <div class="form-group mb-50">
                                            ...
                                            <button type="submit" class="btn btn-success  pull-right">Crear nuevo vehículo</button>
